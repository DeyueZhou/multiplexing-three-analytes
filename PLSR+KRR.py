...
PARAM_GRID = {
    ...
    "krr__regressor__alpha": [1e-4, 1e-3, 1e-2, 1e-1, 1, 10],
    "krr__regressor__gamma": [1e-4, 1e-3, 1e-2, 1e-1, 1],
}
...
def build_model(raman_columns):
    ...
    return Pipeline(
        [
            ...
            ("krr", TransformedTargetRegressor(regressor=krr, transformer=StandardScaler())),
        ]
    )
